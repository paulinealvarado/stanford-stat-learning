...
example: predict market decrease if posterior probability is >=90%. no returns because no day in 2005 meet that thresshold. greatest porbability of decrease in all of 2005 is 52.2%
```{r echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
